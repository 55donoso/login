...
if (empty($correo) || empty($contraseña) || empty($confirmarContraseña)) {
    ...
    header("Location:signup.php?error=" . $error . "&&correo=" . $correo . "&&contraseña=" . $contraseña . "&&confirmarContraseña=" . $confirmarContraseña); //esto es contatenar los valores
    ...
    if ($contraseña == $confirmarContraseña) {
        ...
        header("Location:signup.php?error=" . $error . "&&correo=" . $correo . "&&contraseña=" . $contraseña . "&&confirmarContraseña=" . $confirmarContrasña);
    }
